...
# A MEMÓRIA RAM QUE FUNCIONAVA NA SUA VERSÃO ANTIGA
tarefas_download = {}

# ==========================================
# ROTAS DE USUÁRIO E CARTEIRA
# ==========================================
...
# ==========================================
# MOTOR DE DOWNLOAD LIVRE DE TRAVAS
# ==========================================
def baixar_xml_seguro(chave):
    ...
    try:
        # Requisita de forma isolada, sem usar Session (evita engarrafamento no Render)
...
def processar_lote_bg(task_id, chaves):
    ...
    try:
        ...
        # Avisa que concluiu para destravar o botão
        if task_id in tarefas_download:
